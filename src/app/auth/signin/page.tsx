...
const SignIn: React.FC = () => {
  ...
  //     document.cookie = "authToken=your-token; path=/; secure; samesite=strict";
  ...
  return (
    <>
      <div className="relative  z-9 min-h-screen rounded-sm shadow-default ">
                ...
                <div className="mb-6">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10  outline-none focus:border-primary focus-visible:shadow-none   text-white dark:focus:border-primary"
                    />
